...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(width, height, "Submarine", NULL, NULL);
	...
	*/
	...
	std::string modelPath = "/Resources/Sky/models/submarinMetal/submarinMetal.gltf";
	...
	float deltaTime = 0.0f; // Initialize outside the loop
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		if (timeDiff >= 1.0 / 30.0)
		{
			...
			std::string newTitle = "Submarine - " + FPS + "FPS / " + ms + "ms";
